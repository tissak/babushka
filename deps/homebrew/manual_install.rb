dep 'homebrew manual install' do
  met? { true }
  meet do
    #sourced from: http://gist.github.com/179275
    ...
    if system("git clone #{REPOSITORY_URL}")
      ...
      system("cd /usr/local && git pull origin masterbrew")
    else
    ...
    puts "* Done. Run 'cd /usr/local && git pull origin masterbrew' to update formulae."
  end
end